...
public class NewStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 520, 120, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (condition) {
            ...
            st = stdcon.addStudentEnquiry(name, nic, phone, age, email, gender, address);
            boolean result = stdcon.insertStudentEnquiry(st);
            if (result) {
